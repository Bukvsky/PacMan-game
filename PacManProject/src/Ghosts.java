...
//    }
    ...
    public void run() {
        ...
        int prevX = x; // Przechowywanie poprzednich współrzędnych
        int prevY = y;

        Thread movementThread = new Thread(() -> {
            while (true) {
                int currentX = this.x; // Oblicz bieżące współrzędne siatki w każdej iteracji
                int currentY = this.y;
                // Oblicz bieżące współrzędne siatki w każdej iteracji
                System.out.println("Poprzednie współrzędne: (" + this.prevX + ", " + this.prevY + ")");
                System.out.println("Obecne współrzędne: (" + currentX + ", " + currentY + ")");
                ...
                this.prevX = currentX; // Zaktualizuj poprzednie współrzędne
                this.prevY = currentY;
